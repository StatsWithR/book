...
![(\#fig:vague-prior)Vague prior for mu: n=100](05-BFnormal-01-known-variance_files/figure-latex/vague-prior-1.pdf) 
...
![(\#fig:effect-size)Prior on standard effect size](05-BFnormal-01-known-variance_files/figure-latex/effect-size-1.pdf) 
...
![(\#fig:prior-effect)Prior effect in the extra sensory perception test](05-BFnormal-01-known-variance_files/figure-latex/prior-effect-1.pdf) 
