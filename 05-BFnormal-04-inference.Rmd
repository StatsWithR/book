...
```{r BF-NC, message=FALSE, fig.width=4, fig.height=4, fig.align='center'}
library(statsr)
data(nc)
...
```{r BF-NC-plot, warning=FALSE, fig.width=4, fig.height=4, fig.align='center', fig.cap="Estimates of effect under H2", fig.align='center'}
library(ggplot2)
