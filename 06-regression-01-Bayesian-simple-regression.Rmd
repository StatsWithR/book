...
The confidence interval of $\alpha$ and $\beta$ can be constructed using the standard errors $\text{se}_{\hat{\alpha}}$ and $\text{se_{\hat{\beta}}$ respectively. To proceed, we introduce notations of some "sums of squares"
$$
\begin{aligned}
