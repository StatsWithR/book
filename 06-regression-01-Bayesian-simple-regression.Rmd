...
Based on the data, a Bayesian would expect that a man with waist circumference of `r round(out[1], 1)` centimeters should have bodyfat of `r round(out[2], 3)`% with 95% chance that it is between `r round(out[3], 3)`% and `r round(out[4], 3)`%.
