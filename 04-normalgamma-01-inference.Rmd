...
out = bayes_inference(tthm, data=tapwater, statistic="mean", type="ci", 
...
```{r statsr-CI-tapwate}
#bayes_inference(tthm, data=tapwater, stat="mean", type="ci",
