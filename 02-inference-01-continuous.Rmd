...
```{r pdf-auc, fig.align='center', fig.cap="Area under curve for the probability density function", echo=FALSE}
...
```{r beta, fig.align="center", fig.cap="Beta family", echo=FALSE}
