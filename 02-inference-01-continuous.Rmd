...
```{r pdf-auc, out.width = '70%', fig.align='center', fig.cap="Area under curve for the probability density function", echo=FALSE}
...
```{r beta, out.width = '80%', fig.align="center", fig.cap="Beta family", echo=FALSE}
