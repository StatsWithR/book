...
As a practical matter, one often does not know sigma, the standard deviation of the normal from which the data come. In that case, you could use a more advanced conjugate family. But there are cases in which it is reasonable to treat the $\sigma$ as known. 
