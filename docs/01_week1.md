...
Table: Prior, likelihood, and posterior probabilities for each of the 9 models

-----------------------------  -------  ------  -----  ------  -------  ------  -----  -----  -----
Model ($p$)                     0.1000   0.200   0.30   0.400   0.5000   6e-01   0.70   0.80   0.90
Prior $P(model)$                0.0600   0.060   0.06   0.060   0.5200   6e-02   0.06   0.06   0.06
Likelihood $P(data | model)$    0.0898   0.218   0.13   0.035   0.0046   3e-04   0.00   0.00   0.00
-----------------------------  -------  ------  -----  ------  -------  ------  -----  -----  -----
