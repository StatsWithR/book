...
We provide the detailed derivations in Section \@ref(sec:derivations).
...
### Derivations of Marginal Posterior Distributions of $\alpha$, $\beta$, $\sigma^2$ {#sec:derivations}
