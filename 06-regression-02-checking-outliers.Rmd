...
# The default of Bayes.outlier.prob function is k=3
...
```{r Case39-new-k}
#outliers.new = Bayes.outlier.prob(bodyfat.lm, k = new_k)
#prob.new.39 = outliers.new$prob.outlier[39]
#prob.new.39
```

The posterior probability of Case 39 being an outlier is about 0.6848<!--r round(prob.new.39, 4)-->. While this is not strikingly large, it is much larger than the marginal prior probability of
```{r}
2 * pnorm(-new_k)
```
if we assume the error $\epsilon_j$ is normall distributed.
