...
```{r JAGS-screenshot, fig.align="center", fig.cap="Posterior with JAGS", echo=FALSE}
knitr::include_graphics("JAGS_screenshot.png")
```
...
```{r posterior, fig.cap="RU-486 Posterior",echo=FALSE}
